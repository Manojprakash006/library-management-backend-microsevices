...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Member email address', example: 'member@example.com' }),
...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Reset token received via email', example: 'abc123xyz' }),
