...
let NotificationsController = class NotificationsController {
    ...
    async subscribeToPush(subscription, req) {
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Notify all staff members' }),
    (0, swagger_1.ApiResponse)({ status: 201, description: 'Staff members notified successfully' }),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], NotificationsController.prototype, "notifyStaff", null);
__decorate([
    (0, public_decorator_1.Public)(),
    (0, common_1.Post)('members'),
    (0, swagger_1.ApiOperation)({ summary: 'Notify all members' }),
    (0, swagger_1.ApiResponse)({ status: 201, description: 'Members notified successfully' }),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], NotificationsController.prototype, "notifyMembers", null);
__decorate([
    (0, common_1.Get)(),
