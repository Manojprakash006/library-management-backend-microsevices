...
], BooksController.prototype, "getReportsData", null);
__decorate([
    (0, roles_decorator_1.Roles)('admin'),
    (0, common_1.Get)('reports/books-performance'),
    (0, swagger_1.ApiOperation)({ summary: 'Get books performance report' }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], BooksController.prototype, "getBooksPerformanceReport", null);
__decorate([
    (0, roles_decorator_1.Roles)('admin'),
    (0, common_1.Get)('reports/reviews'),
    (0, swagger_1.ApiOperation)({ summary: 'Get reviews report' }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], BooksController.prototype, "getReviewsReport", null);
__decorate([
