...
export declare class DashboardService {
    ...
    constructor(bookModel: Model<BookDocument>, bookRequestModel: Model<BookRequestDocument>, httpService: HttpService, redisEmitter: RedisEmitterService);
    ...
    getStatCards(authHeader?: string): Promise<any>;
    getBooksAddedTodayList(): Promise<(import("mongoose").FlattenMaps<import("mongoose").Document<unknown, {}, Book, {}, {}> & Book & {
        _id: import("mongoose").Types.ObjectId;
    } & {
        __v: number;
    }> & Required<{
    ...
    getBooksAddedToday(): Promise<number>;
    ...
    private populateIssuesBulk;
    private getBooksMap;
    private getMembersMap;
