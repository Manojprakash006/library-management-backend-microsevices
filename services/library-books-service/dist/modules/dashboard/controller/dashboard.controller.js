...
let DashboardController = class DashboardController {
    ...
    async getStatCards(req) {
        const authHeader = req.headers['authorization'];
        const result = await this.dashboardService.getStatCards(authHeader);
...
__decorate([
    ...
    (0, roles_decorator_1.Roles)('admin', 'staff'),
    (0, swagger_1.ApiOperation)({ summary: 'Get books added today (full details)' }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], DashboardController.prototype, "getBooksAddedTodayList", null);
__decorate([
    (0, common_1.Get)('books-added-today'),
    (0, roles_decorator_1.Roles)('admin', 'staff'),
    (0, swagger_1.ApiOperation)({ summary: 'Get count of books added today' }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], DashboardController.prototype, "getBooksAddedToday", null);
__decorate([
