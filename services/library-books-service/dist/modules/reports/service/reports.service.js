...
let ReportsService = ReportsService_1 = class ReportsService {
    constructor(bookModel, bookReviewModel, httpService) {
    ...
    getFilterDateRange(filterType, startDateStr, endDateStr) {
        if (!filterType)
            return null;
    ...
    filterByDateRange(items, dateKeys, range) {
        if (!range)
            return items;
        return items.filter(item => {
            ...
            if (!val)
                val = item.createdAt || item.updatedAt;
            if (!val)
                return true;
    ...
    async fetchIssues(authHeader) {
        try {
            const issuesServiceUrl = process.env.ISSUES_SERVICE_URL || 'http://library-issues-service:3013';
            const response = await (0, rxjs_1.firstValueFrom)(this.httpService.get(`${issuesServiceUrl}/issues?limit=1000`, this.getHeaders(authHeader)));
    ...
    async fetchMembers(authHeader) {
        try {
            const membersServiceUrl = process.env.MEMBERS_SERVICE_URL || 'http://library-members-service:3012';
            const response = await (0, rxjs_1.firstValueFrom)(this.httpService.get(`${membersServiceUrl}/members?limit=1000`, this.getHeaders(authHeader)));
            return response.data?.data || response.data || [];
        }
        catch (error) {
    ...
    async fetchStaff(authHeader) {
        try {
            const membersServiceUrl = process.env.MEMBERS_SERVICE_URL || 'http://library-members-service:3012';
            const response = await (0, rxjs_1.firstValueFrom)(this.httpService.get(`${membersServiceUrl}/staff?limit=1000`, this.getHeaders(authHeader)));
            return response.data?.data || response.data || [];
        }
        catch (error) {
    ...
    async fetchAttendance(authHeader) {
        try {
            const membersServiceUrl = process.env.MEMBERS_SERVICE_URL || 'http://library-members-service:3012';
            const response = await (0, rxjs_1.firstValueFrom)(this.httpService.get(`${membersServiceUrl}/attendance/all`, this.getHeaders(authHeader)));
    ...
    async fetchFines(authHeader) {
        try {
            const paymentsServiceUrl = process.env.PAYMENTS_SERVICE_URL || 'http://library-payments-service:3005';
            const response = await (0, rxjs_1.firstValueFrom)(this.httpService.get(`${paymentsServiceUrl}/fines?limit=1000`, this.getHeaders(authHeader)));
            return response.data?.data || response.data || [];
        }
        catch (error) {
    ...
    async fetchRequests(authHeader) {
        try {
            const requestsServiceUrl = process.env.REQUESTS_SERVICE_URL || 'http://library-requests-service:3014';
            const response = await (0, rxjs_1.firstValueFrom)(this.httpService.get(`${requestsServiceUrl}/requests?limit=1000`, this.getHeaders(authHeader)));
            return response.data?.data || response.data || [];
        }
        catch (error) {
    ...
    async fetchSuggestions(authHeader) {
        try {
            const requestsServiceUrl = process.env.REQUESTS_SERVICE_URL || 'http://library-requests-service:3014';
            const response = await (0, rxjs_1.firstValueFrom)(this.httpService.get(`${requestsServiceUrl}/suggestions`, this.getHeaders(authHeader)));
            return response.data || [];
        }
        catch (error) {
    ...
    async getOverviewReport(authHeader, filterType, startDate, endDate) {
        ...
        filteredIssues.forEach(iss => {
            ...
            if (hour >= 19)
                ...
                slot = '11:00';
            if (hourlyDistribution[slot])
                hourlyDistribution[slot].issues++;
        });
        filteredReturns.forEach(iss => {
            if (iss.returnDate) {
                ...
                if (hour >= 19)
                    ...
                    slot = '11:00';
                if (hourlyDistribution[slot])
                    hourlyDistribution[slot].returns++;
            }
        });
    ...
    async getStaffReport(authHeader, filterType, startDate, endDate) {
    ...
    async getBooksReport(authHeader, filterType, startDate, endDate) {
    ...
    async getMembersReport(authHeader, filterType, startDate, endDate) {
    ...
    async getPaymentsReport(authHeader, filterType, startDate, endDate) {
    ...
    async getRequestsReport(authHeader, filterType, startDate, endDate) {
    ...
    async getReviewsReport(authHeader, filterType, startDate, endDate) {
    ...
    async getActiveMembersCount(authHeader) {
        try {
            const membersServiceUrl = process.env.MEMBERS_SERVICE_URL || 'http://library-members-service:3012';
            const response = await (0, rxjs_1.firstValueFrom)(this.httpService.get(`${membersServiceUrl}/members/stats/active`, this.getHeaders(authHeader)));
    ...
    async getInactiveMembersCount(authHeader) {
        try {
            const membersServiceUrl = process.env.MEMBERS_SERVICE_URL || 'http://library-members-service:3012';
            const response = await (0, rxjs_1.firstValueFrom)(this.httpService.get(`${membersServiceUrl}/members/stats/inactive`, this.getHeaders(authHeader)));
            return response.data?.data || 0;
        }
        catch {
            return 0;
